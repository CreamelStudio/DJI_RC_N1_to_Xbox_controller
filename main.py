...
parser.add_argument('-p', '--port', help='RC Serial Port', default="COM6")
...
s = serial.Serial(port=ports[PortSelect].name, baudrate=115200)
camera = 0
print("Open Serial Ready")
print("Open Serial Start")
result = []
ports = serial.tools.list_ports.comports(True)
for ports in ports:
    print(ports.description)
    if ports.description.find("DJI USB VCOM For Protocol") == 0:
        print("found DJI USB VCOM For Protocol")
        s = serial.Serial(ports=ports[PortSelect].name, baudrate=115200)
